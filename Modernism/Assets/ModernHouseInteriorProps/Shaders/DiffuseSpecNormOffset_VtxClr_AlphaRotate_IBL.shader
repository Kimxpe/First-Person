...
Shader "Shader Forge/DiffuseSpecNormOffset_AlphaRotate_IBL" {
    Properties {
        ...
        _DiffusePanningSpeed ("Diffuse Panning Speed", Range(0, 1)) = 0.12
        _DiffuseDistortionIntensity ("Diffuse Distortion Intensity", Range(0, 1)) = 0.08
        ...
        _AlphaOffsetSpeed ("Alpha Offset Speed", Range(0, 1)) = 0.2
        _RefractionIntensity ("Refraction Intensity", Range(0, 1)) = 0.08
        ...
        _SpecularIBLIntensity ("Specular IBL Intensity", Float ) = 2
        _SpecularIBLCubemap ("Specular IBL (Cubemap)", Cube) = "_Skybox" {}
        _NormalIntensity ("Normal Intensity", Range(0, 20)) = 20
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalLocal = lerp(float3(0,0,1),node_5364,_NormalIntensity);
...
////// Specular:
                ...
                float3 indirectSpecular = (gi.indirect.specular + ((_SpecularIBLIntensity*_SpecularIBLCubemap_var.a)*_SpecularIBLCubemap_var.rgb));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float2 node_5107 = lerp(i.uv0,float2(_DiffDistortionMapR_var.r,_DiffDistortionMapR_var.r),_DiffuseDistortionIntensity);
                float4 _DiffuseRGBSpecA_var = tex2D(_DiffuseRGBSpecA,TRANSFORM_TEX(node_5107, _DiffuseRGBSpecA));
                float3 diffColor = (_DiffuseColor.rgb*_DiffuseRGBSpecA_var.rgb*_DiffuseIntensity);
                float4 _SpecularG_var = tex2D(_SpecularG,TRANSFORM_TEX(i.uv0, _SpecularG));
                float3 specColor = (_SpecularColor.rgb*_SpecularG_var.rgb*_SpecularIntensity);
                float specularMonochrome = max(max(specColor.r, specColor.g),specColor.b);
                diffColor *= (1.0-specularMonochrome);
                float roughness = 1.0 - (_SpecularG_var.a*_GlossIntensity);
